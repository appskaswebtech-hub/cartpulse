...
type Module = typeof import("../webhooks.cart-activity.checkout-sync.js")

type Info = GetInfo<{
  file: "routes/webhooks.cart-activity.checkout-sync.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../webhooks.cart-activity.checkout-sync.js");
}];
