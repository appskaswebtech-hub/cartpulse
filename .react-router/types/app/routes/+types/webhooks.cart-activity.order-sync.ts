...
type Module = typeof import("../webhooks.cart-activity.order-sync.js")

type Info = GetInfo<{
  file: "routes/webhooks.cart-activity.order-sync.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../webhooks.cart-activity.order-sync.js");
}];
